...
public class StockWatcher implements EntryPoint {
	...
	private void loadStockWatcher(){
		...
		stocksFlexTable.setText(0, 1, "$");  
		stocksFlexTable.setText(0, 2, "MODIFY");  
		stocksFlexTable.setText(0, 3, "REM0VE");
	    ...
	    addPanel.addStyleName("addPanel"); // to apply the css

	    // Assemble Main panel.
	    mainPanel.add(signOutLink); // for log out
	...
	private void displayStocks(String[] symbols) {  
		...
		// called when adding a new stock, and every
	  /**
	  ...
	  private void updateTable(StockPrice price) {
	    ...
	    //REMOVING THIS >>> stocksFlexTable.setText(row, 2, changeText + " (" + changePercentText + "%)");
	  ...
	  private void displayStock(final String symbol){
		    ...
		    removeStockButton.addStyleDependentName("remove"); // for remove button css
